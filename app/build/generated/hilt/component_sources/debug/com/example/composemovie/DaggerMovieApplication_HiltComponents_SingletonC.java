...
import com.example.composemovie.data.di.AppModule;
import com.example.composemovie.data.di.AppModule_ProvideMovieAppFactory;
import com.example.composemovie.data.di.AppModule_ProvideMovieRepositoryFactory;
...
import com.example.composemovie.presentation.MainActivity;
import com.example.composemovie.presentation.movie_detail.MovieDetailViewModel;
import com.example.composemovie.presentation.movie_detail.MovieDetailViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.composemovie.presentation.movies.MoviesViewModel;
import com.example.composemovie.presentation.movies.MoviesViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMovieApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends MovieApplication_HiltComponents.ActivityC {
    ...
    public Set<String> getViewModelKeys() {
      return SetBuilder.<String>newSetBuilder(2).add(MovieDetailViewModel_HiltModules_KeyModule_ProvideFactory.provide()).add(MoviesViewModel_HiltModules_KeyModule_ProvideFactory.provide()).build();
    }
  ...
  private static final class ViewModelCImpl extends MovieApplication_HiltComponents.ViewModelC {
    ...
    private GetMovieDetailUseCase getMovieDetailUseCase() {
      return new GetMovieDetailUseCase(singletonCImpl.provideMovieRepositoryProvider.get());
    }

    private GetMovieUseCase getMovieUseCase() {
      return new GetMovieUseCase(singletonCImpl.provideMovieRepositoryProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final SavedStateHandle savedStateHandleParam,
        final ViewModelLifecycle viewModelLifecycleParam) {
      this.movieDetailViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 0);
      this.moviesViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 1);
    }

    @Override
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.example.composemovie.presentation.movie_detail.MovieDetailViewModel", ((Provider) movieDetailViewModelProvider)).put("com.example.composemovie.presentation.movies.MoviesViewModel", ((Provider) moviesViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.composemovie.presentation.movie_detail.MovieDetailViewModel 
          return (T) new MovieDetailViewModel(viewModelCImpl.getMovieDetailUseCase(), viewModelCImpl.savedStateHandle);

          case 1: // com.example.composemovie.presentation.movies.MoviesViewModel 
          return (T) new MoviesViewModel(viewModelCImpl.getMovieUseCase());
  ...
  private static final class SingletonCImpl extends MovieApplication_HiltComponents.SingletonC {
    ...
    private Provider<MovieAPI> provideMovieAppProvider;

    private Provider<IMovieRepository> provideMovieRepositoryProvider;
    ...
    @SuppressWarnings("unchecked")
    private void initialize() {
      this.provideMovieAppProvider = DoubleCheck.provider(new SwitchingProvider<MovieAPI>(singletonCImpl, 1));
      this.provideMovieRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<IMovieRepository>(singletonCImpl, 0));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.composemovie.domain.repository.IMovieRepository 
          return (T) AppModule_ProvideMovieRepositoryFactory.provideMovieRepository(singletonCImpl.provideMovieAppProvider.get());

          case 1: // com.example.composemovie.data.remote.MovieAPI 
          return (T) AppModule_ProvideMovieAppFactory.provideMovieApp();
